...
let result1 = ImageProcessor(["IncreaseTransperancy","IncreaseRed"], intensity: [100,5])
let result2 = ImageProcessor(["IncreaseRed","DecreaseBlue"], intensity: [10,5])
let result3 = ImageProcessor(["IncreaseGreen","IncreaseTransperancy"], intensity: [10,100])
let result4 = ImageProcessor(["IncreaseRed","DescreaseRed"], intensity: [5,5])
let result5 = ImageProcessor(["IncreaseRed","IncreaseGreen","IncreaseBlue"], intensity: [5,5,5])
